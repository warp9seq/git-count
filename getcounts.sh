...
LIST="minimod openfish kuva buttery-eel blue-crab f5c slow5lib slow5tools sigtk squigulator cornetto slow5curl slorado bedpull poa-consensus squigualiser"
